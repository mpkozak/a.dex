      ...
      <div className="instructions outer">
        <div className={`show ${show ? null : 'hide'}`} onClick={toggle}>
          ...
          <ul className="list">
            ...
            <li className="step">Click on one of the orbs in "Set Colors". Hold one of your controllers up in front of you and click where it appears within the video frame. You should see a tracking circle appear that matches the color of your controller. Repeat for the controller.</li>
