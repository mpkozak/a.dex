      ...
      <div className="instructions outer">
        <div className={`show ${show ? null : 'hide'}`} onClick={toggle}>
          ...
          <ul className="list">
            ...
            <li className="step">To Calibrate: Tap on one of the colored orbs below the screen. Hold one of your trackers up in front of you and tap where it appears within the video frame. You should see a tracking circle appear that matched the color and size of your controller. Repeat for the other controller.</li>
