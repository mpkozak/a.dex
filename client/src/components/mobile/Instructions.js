    ...
    <div id="InstructionsMobile" className="outer">
      <div className={`instructions-box ${active ? 'show' : 'hide'}`}>
        ...
        <ul className="list">
          ...
          <li className="step">To Calibrate, tap on one of the colored orbs below the screen. Hold one of your controllers in front of the camera and tap where it appears within the video frame. You should see a tracking circle appear that matches the color of your controller. Repeat for the other controller.</li>
