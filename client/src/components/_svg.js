    ...
    return (
      <svg id="svg-defs" className="invisible" width="0" height="0">
        <defs>
          ...
          <linearGradient id="glowbutton-contour-vertical" x1="0%" y1="0%" x2="100%" y2="0%" gradientUnits="objectBoundingBox">
            <stop offset="0%" stopColor="#000000" stopOpacity="1" />
            <stop offset="8%" stopColor="#000000" stopOpacity="0" />
            <stop offset="92%" stopColor="#000000" stopOpacity="0" />
            <stop offset="100%" stopColor="#000000" stopOpacity="1" />
      ...
      <stop offset="100%" stopColor="#000000" stopOpacity=".5"/>
          ...
          <linearGradient id="slider-ridges-left" x1="0%" y1="0%" x2="100%" y2="0%" gradientUnits="objectBoundingBox">
            ...
            {new Array(5).fill('').map((d, i) => {
              const unit = (100 / 6);
              return (
                <React.Fragment key={'slider-ridges-left-' + i}>
                  <stop offset={(unit * (i + 1)) + '%'} stopColor="#000000" stopOpacity="0" />
                  <stop offset={(unit * ((i + 1) + .1)) + '%'} stopColor="#000000" stopOpacity=".3" />
                  <stop offset={(unit * ((i + 1) + .5)) + '%'} stopColor="#000000" stopOpacity=".8" />
                </React.Fragment>
              );
            })}
            <stop offset="100%" stopColor="#000000" stopOpacity="0" />
          </linearGradient>
          <linearGradient id="slider-ridges-right" x1="0%" y1="0%" x2="100%" y2="0%" gradientUnits="objectBoundingBox">
            {new Array(5).fill('').map((d, i) => {
              const unit = (100 / 6);
              return (
                <React.Fragment key={'slider-ridges-right-' + i}>
            ...
            <stop offset="83.3333%" stopColor="#000000" stopOpacity="0" />
            <stop offset="91.6667%" stopColor="#000000" stopOpacity=".8" />
            <stop offset="100%" stopColor="#000000" stopOpacity="1" />
          </linearGradient>
...
///////////////////////////
// Parent SVG Components //
  export const Fader = ({ pct, handleTouchMove }) => {
    const level = 5 + (pct * 60);
    return (
  ...
  export const xMeterWave = ({ wave = 'M 0 30 L 100 30' }) => {
    return (
  ...
  export const xMeterVU = ({ rotation = -48, peak = false }) => {
    const ticks = [
