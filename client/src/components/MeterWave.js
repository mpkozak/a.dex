...
export default class MeterWave extends PureComponent {
  constructor(props) {
    super(props);
    this.colorBg = '#052205';
    this.gridLines = [7.25, 11.75, 16.25, 20.75, 25.25, 29.75, 34.25, 38.75, 43.25, 47.75, 52.25, 56.75, 61.25, 65.75, 70.25, 74.75, 79.25, 83.75, 88.25, 92.75];
  };

  render() {
    const { colorBg, gridLines } = this;
    ...
    return (
      <svg className="meter" viewBox="0 0 100 60">
        ...
        <g className="wave-interior" clipPath="url(#meter-inner-clip)">
          ...
          <path id="wave-path" d={wave ? wave : undefined} opacity={opacity} fill="none" stroke="#A0FFA0" strokeWidth=".15%" />
          <MeterPanelShadow />
        </g>
      </svg>
    );
